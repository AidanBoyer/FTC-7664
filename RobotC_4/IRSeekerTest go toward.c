...
task main()
{
	while(true)
	{
    	...
    	case 1:
				driveMotors(80,80,-90,-90);
			break;

			case 2:
				driveMotors(-10,-10,70,70);
			break;

			case 3:
   	 		driveMotors(65,65,10,10);
    	break;

  		case 4:
   	 		driveMotors(65,65,25,25);
    	break;
    	...
    	break;
  		...
  		case 6:
   	 		driveMotors(25,25,65,65);
    	break;

    	case 7:
   	 		driveMotors(10,10,65,65);
    	break;

    	case 8:
    		driveMotors(70,70,-10,-10);
			break;
