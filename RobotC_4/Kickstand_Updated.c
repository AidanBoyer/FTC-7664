...
const float feetToTravel = 4.0;  // tells how many feet we want the robot to move
...
void setMotors(int left, int right) // sets the power of all the motors to the value passed to this function
{
...
task main() // main task
{
  ...
  {
  	moveAllMotors(50);  // Calls the "moveAllMotors" function, setting the power of all motors to 99%
  }

  reset();

  while (((nMotorEncoder[LeftFrontDrive] + nMotorEncoder[LeftRearDrive] + nMotorEncoder[RightFrontDrive]
	+ nMotorEncoder[RightRearDrive]) / 4)*-1 < ticksToTravel/2) // repeat this section of code (do not continue sequential
	// execution) until the average of all four motor values is greater than the target number of ticks to move,
	// calculated from the specified number of feet to move.
  {
  	moveAllMotors(-50);  // Calls the "moveAllMotors" function, setting the power of all motors to 99%
	...
	while (((nMotorEncoder[LeftFrontDrive] + nMotorEncoder[LeftRearDrive] - nMotorEncoder[RightFrontDrive]
	- nMotorEncoder[RightRearDrive]) / 4) < ticksToTravel/10) // repeat this section of code (do not continue sequential
	// execution) until the average of all four motor values is greater than the target number of ticks to move,
	// calculated from the specified number of feet to move.
  {
  	setMotors(50, -50);  // Calls the "moveAllMotors" function, setting the power of all motors to 99%
  }

	reset();

	while (((nMotorEncoder[LeftFrontDrive] + nMotorEncoder[LeftRearDrive] + nMotorEncoder[RightFrontDrive]
	+ nMotorEncoder[RightRearDrive]) / 4) < ticksToTravel/4) // repeat this section of code (do not continue sequential
	// execution) until the average of all four motor values is greater than the target number of ticks to move,
	// calculated from the specified number of feet to move.
  {
  	moveAllMotors(50);  // Calls the "moveAllMotors" function, setting the power of all motors to 99%
  ...
  while (((nMotorEncoder[LeftFrontDrive] + nMotorEncoder[LeftRearDrive] - nMotorEncoder[RightFrontDrive]
	- nMotorEncoder[RightRearDrive]) / 4)*-1 < ticksToTravel/7.5) // repeat this section of code (do not continue sequential
	// execution) until the average of all four motor values is greater than the target number of ticks to move,
	// calculated from the specified number of feet to move.
  {
  	setMotors(-50, 50);  // Calls the "moveAllMotors" function, setting the power of all motors to 99%
