...
#pragma config(Sensor, S2,     MiscController, sensorI2CMuxController)
...
#pragma config(Motor,  mtr_Matrix_S2_1,  ,             tmotorMatrix, openLoop)
#pragma config(Motor,  mtr_Matrix_S2_2,  ,             tmotorMatrix, openLoop)
#pragma config(Motor,  mtr_Matrix_S2_3,  ,             tmotorMatrix, openLoop)
#pragma config(Motor,  mtr_Matrix_S2_4,  ,             tmotorMatrix, openLoop)
